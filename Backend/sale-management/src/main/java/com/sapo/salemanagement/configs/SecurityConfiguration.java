package com.sapo.salemanagement.configs;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/admin/customer/**").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.CARE.name())
                        .requestMatchers(HttpMethod.POST, "/admin/customer/**").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.CARE.name())
                        .requestMatchers(HttpMethod.PUT, "/admin/customer/**").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.CARE.name())
                        .requestMatchers(HttpMethod.DELETE, "/admin/customer/**").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.CARE.name())
                        ...
                        .requestMatchers("/admin/orders/**").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.SALE.name())
                        .requestMatchers(HttpMethod.POST, "/admin/orders/**").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.SALE.name())
                        .requestMatchers(HttpMethod.PUT, "/admin/orders/**").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.SALE.name())
                        .requestMatchers(HttpMethod.DELETE, "/admin/orders/**").hasAnyAuthority(RoleType.ADMIN.name(), RoleType.SALE.name())
